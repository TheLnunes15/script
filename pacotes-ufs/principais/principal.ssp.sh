...
pacman -S alsa-utils alsa-tools flashplugin file-roller cdrkit lrzip p7zip python unace unrar jdk8-openjdk libreoffice openssh bleachbit onboard evince gedit cvsps codeblocks eclipse gimp firefox chromium vlc gvfs dosfstools mariadb postgresql mysql-workbench tcl tk --needed --noconfirm
echo "Feito."
